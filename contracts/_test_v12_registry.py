...
def main() -> int:
    if not (kit.v12_available() and kit.registry_available()):
    ...
    print("register:")
    # V12 (CHIP-0062 review P1, "the final LP position cannot redeem"): the locked minimum is
    ...
    refuses("V12: a genesis supply below MIN_LOCKED_LP is refused at registration",
