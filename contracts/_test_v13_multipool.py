...
from _test_v13_offer_lane import ROUTER_PH, T_A, T_B, TRADER_PH, H, fabricate_offer, make  # noqa: E402
...
def main() -> int:
    ...
    fa = v13r.simulate_chain([xa], [hx(None), hx(T_A)], g)[0]
    fb = v13r.simulate_chain([ab], [hx(T_A), hx(T_B)], fa)[0]
    ...
    b_bought = v13r.simulate_chain([ab], [hx(T_A), hx(T_B)], sell_a)[0]
