#!/usr/bin/env python3
"""V12 genesis binds to exactly one LP eve (CHIP-0062 review P0).
...
V12 puts the eve's own coin id into the announced list: the launcher announces
...
def main():
    ...
    if out:
        ...
        check("  exactly total_lp LP was created", sum(a for ph, a in additions if ph == lp_ph) == total)
    ...
    print()
    print(f"{'ALL PASSED' if not FAILED else f'{FAILED} FAILED'} -- V12 genesis checks")
