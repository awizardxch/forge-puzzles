...
deployment record (.awizard/v12-testnet.json) and asks the node the questions a
...
RECORD = pathlib.Path(__file__).resolve().parent.parent / ".awizard" / "v12-testnet.json"
