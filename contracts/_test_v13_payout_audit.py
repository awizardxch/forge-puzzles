...
from _test_v13_offer_lane import ROUTER_PH, T_A, TRADER_PH, H, fabricate_offer, make, paid_to  # noqa: E402
...
def main() -> int:
    ...
    for bps in (0, 30, 300, 500):
        ...
        out = forge_stdin.build({"action": "swap", "offer": offer.to_bech32(), "current_height": H, "pool": v13.pool_to_snapshot(pool),
    ...
    try:
        forge_stdin.build({"action": "swap", "offer": offer.to_bech32(), "current_height": H,
                           "pool": v13.pool_to_snapshot(pool),
    ...
    try:
        forge_stdin.build({"action": "swap", "offer": offer.to_bech32(), "current_height": H, "pool": v13.pool_to_snapshot(pool),
