...
def main() -> int:
    ...
    bundle, st = kit.spend_action(pool, "forge_action_swap", [H0, 0, 1, gross, honest, s1.name()], extra_spends=[s1_spend])
    ...
    if validates("the DAO lowers to zero", bundle):
        ...
        bundle, st5 = kit.spend_action(zeroed, "forge_action_swap", [H0 + 2, 0, 1, gross, honest, s2.name()], extra_spends=[s2_spend])
    ...
    bundle, st6 = kit.spend_actions(pool, [("forge_action_dao_fee", [H0, 20]),
                                           ("forge_action_swap", [H0, 0, 1, gross, honest, s3.name()])],
