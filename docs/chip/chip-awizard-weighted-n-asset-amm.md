...
* Full protocol specification, with what each leaf asserts and which test pins each refusal - [`FORGE_PUZZLE_V13.md`](https://github.com/awizardxch/forge-puzzles/blob/main/docs/FORGE_PUZZLE_V13.md)
* Architecture as built: coin topology, spend anatomy, authorization, the registry and the off-chain lanes - [`FORGE_V13_ARCHITECTURE.md`](https://github.com/awizardxch/forge-puzzles/blob/main/docs/FORGE_V13_ARCHITECTURE.md)
* The written CLVM pass, leaf by leaf: every assertion, what it closes, and which suite pins it - [`FORGE_V13_CLVM_PASS.md`](https://github.com/awizardxch/forge-puzzles/blob/main/docs/FORGE_V13_CLVM_PASS.md)
